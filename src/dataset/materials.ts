...
const materials: Material[] = [
  ...
  i('紅草', 'R', t.CONSUMABLE, ['斬の盾', '火の祝福']),
  i('煌く砂', 'R', t.CONSUMABLE, ['剛力の呪詛', '破壊力上昇']),
  // i('', 'R', t.CONSUMABLE, ['', '']),
  ...
  i('フロジストン', 'B', t.CONSUMABLE, ['雷の祝福', '大きな回復量']),
  // i('', 'B', t.CONSUMABLE, ['', '']),
  ...
  i('トキシーアント', 'G', t.CONSUMABLE, ['雷の呪詛', '氷の盾']),
  i('コベリナイト', 'G', t.CONSUMABLE, ['斬の祝福', '斬の盾']),
  i('綿毛草', 'G', t.CONSUMABLE, ['打の祝福', '打の盾']),
  i('ファニプラント', 'G', t.CONSUMABLE, ['風の呪詛', '突の盾']),
  i('幻惑の木片', 'G', t.CONSUMABLE, ['打の呪詛', '大きな回復量']),
  i('シュランク', 'G', t.CONSUMABLE, ['破壊力上昇', '全体回復ボーナス']),
  // i('', 'G', t.CONSUMABLE, ['', '']),
  ...
  i('フェロス・モルグ', 'P', t.CONSUMABLE, ['守護の祝福', '斬の祝福']),
  i('プルムル', 'P', t.CONSUMABLE, ['打の呪詛', '雷の盾']),
  // i('', 'P', t.CONSUMABLE, ['', '']),

  i('エスプラント', 'R', t.EQUIPMENT, ['獣ダメージ上昇', '獣ダメージ軽減']),
  i('インゴットバグ', 'R', t.EQUIPMENT, ['雷ダメージ上昇', '全体回復量上昇']),
  i('闇の雫', 'R', t.EQUIPMENT, ['物理ダメージ上昇', '物理/魔法耐性ダウン強化']),
  ...
  i('赤玉鉱石', 'B', t.EQUIPMENT, ['全体攻撃威力上昇', '斬耐性上昇']),
  ...
  i('熔けあう硬木', 'B', t.EQUIPMENT, ['回復量上昇【渾身】', '獣ダメージ上昇']),
  i('黒玉鉱石', 'B', t.EQUIPMENT, ['斬ダメージ上昇', '魔法耐性上昇【渾身】']),
  // i('', 'B', t.EQUIPMENT, ['', '']),

  i('雲海の隠れ家', 'G', t.EQUIPMENT, ['ブレイクダメージ上昇【背水】', '物理耐性上昇【D】']),
  i('ベビーヴルム', 'G', t.EQUIPMENT, ['打ダメージ上昇', '全体回復量上昇']),
  i('甘露の湧水', 'G', t.EQUIPMENT, ['魔法ダメージ上昇', '物理/魔法耐性ダウン強化']),
  i('湖底のぬし', 'G', t.EQUIPMENT, ['ダメージバフ強化【A】', '風ダメージ上昇']),
  ...
  i('スピリト・モルグ', 'G', t.EQUIPMENT, ['物理ダメージ上昇【渾身】', '物理/魔法耐性アップ強化']),
  ...
  i('酸いの実', 'G', t.EQUIPMENT, ['雷ダメージ上昇', '打耐性上昇']),
  i('ハイネの炎石', 'G', t.EQUIPMENT, ['火ダメージ上昇', '単体回復量上昇']),
  i('チョウロウウオ', 'G', t.EQUIPMENT, ['単体攻撃威力上昇', '精霊ダメージ軽減']),
  i('ヴァイヒ', 'G', t.EQUIPMENT, ['ぷにダメージ上昇', '回復量上昇【背水】']),
  i('スピアワーム', 'G', t.EQUIPMENT, ['精霊ダメージ上昇', '物理耐性上昇【渾身】']),
  // i('', 'G', t.EQUIPMENT, ['', '']),
  ...
  i('赤熱結晶', 'Y', t.EQUIPMENT, ['ダメージバフ強化【A】', '回復量上昇【D】']),
  ...
  i('ホシナナ', 'Y', t.EQUIPMENT, ['スキル威力上昇', '火耐性上昇']),
  i('ブランチトランク', 'Y', t.EQUIPMENT, ['全体攻撃耐性上昇', '回復量上昇【渾身】']),
  i('モノノフバッタ', 'Y', t.EQUIPMENT, ['ブレイク中ダメージ上昇', '物理耐性上昇【渾身】']),
  i('フラムドラグーン', 'Y', t.EQUIPMENT, ['物理ダメージ上昇【背水】', '物理/魔法耐性アップ強化【D】']),
  i('ザフロア油', 'Y', t.EQUIPMENT, ['火ダメージ上昇', '物理/魔法耐性ダウン強化']),
  // i('', 'Y', t.EQUIPMENT, ['', '']),
  ...
  i('聖石の欠片', 'P', t.EQUIPMENT, ['全耐性上昇【背水】', '物理/魔法耐性ダウン強化']),
  i('老木の枝葉', 'P', t.EQUIPMENT, ['ブレイク中ダメージ上昇', 'ダメージバフ強化【B】']),
  i('恩寵の淑女', 'P', t.EQUIPMENT, ['物理ブレイクダメージ上昇', '突耐性上昇']),
  // i('', 'P', t.EQUIPMENT, ['', '']),
  ...
  // リディー＆スールの日常
  i('星の実', 'G', t.EQUIPMENT, ['全体攻撃威力上昇', '水棲ダメージ軽減']),
  i('ハイネライト', 'B', t.CONSUMABLE, ['打の呪詛', '追い打ち強化']),
  i('星の花', 'B', t.EQUIPMENT, ['物理/魔法耐性ダウン強化', '打ダメージ上昇']),
  i('黄金樹の葉', 'R', t.CONSUMABLE, ['水棲特攻', '雷の呪詛']),
  i('オオカニカブト', 'Y', t.CONSUMABLE, ['打の祝福', '全体回復ボーナス']),
  i('玉鋼石', 'P', t.CONSUMABLE, ['氷の盾', '使い切り攻撃強化']),

  // 忘却の賢者と秘密の楽園
  i('ヤギミルク', 'P', t.EQUIPMENT, ['ブレイクダメージ上昇', '氷耐性上昇']),
  i('夢見の霧花', 'P', t.CONSUMABLE, ['獣特攻', '魔防の祝福']),
  i('森の賢人', 'G', t.EQUIPMENT, ['魔法耐性上昇【D】', '単体攻撃威力上昇']),
  i('七煌原石', 'B', t.CONSUMABLE, ['斬の呪詛', '獣特攻']),
  i('大王うに', 'Y', t.CONSUMABLE, ['火の呪詛', '打の盾']),
  i('ゴールデンクラウン', 'R', t.EQUIPMENT, ['ダメージバフ強化【B】', 'ブレークダメージ上昇【背水】']),

  // ライザからの挑戦状
  i('デルフィローズ', 'B', t.EQUIPMENT, ['物理ブレイクダメージ上昇', '斬ダメージ上昇']),
  i('創世の逆さ石', 'Y', t.CONSUMABLE, ['大きな回復量', '単体回復ボーナス']),
