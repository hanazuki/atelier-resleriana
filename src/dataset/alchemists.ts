...
const alchemists: Alchemist[] = [
  ...
  a('アンペル', '門を閉ざす者', 3, 'R', 'P', ['打の盾', '雷の祝福', '物理ダメージ上昇【渾身】']),
  ...
  a('ウィルベル', 'Magical Trick Star', 3, 'R', 'P', ['火の祝福', '打の呪詛', '魔法ダメージ上昇']),
  ...
  a('スール', 'Ambition Painting', 3, 'Y', 'G', ['突の盾', '破壊力上昇', '物理ダメージ上昇【渾身】']),
  ...
  a('ニオ', 'チャーミングシスター', 3, 'Y', 'G', ['火の盾', '追い打ち強化', '物理/魔法耐性アップ強化【D】']),
  a('フィリス', 'Crystal Master', 3, 'Y', 'R', ['魔力の呪詛', '突の祝福', '火耐性上昇']),
  a('プラフタ', 'ミステリアスドール', 3, 'Y', 'P', ['打の呪詛', '打の盾', '打ダメージ上昇']),
  a('プラフタ', '魅惑のヴァンパイア', 3, 'R', 'B', ['斬の祝福', '単体回復ボーナス', '物理ダメージ上昇']),
  ...
  a('メルル', 'Damsel in Distress', 3, 'G', 'Y', ['氷の呪詛', '守護の祝福', '単体攻撃威力上昇']),
  a('モニカ', 'モニカオンステージ', 2, 'R', 'B', ['突の祝福', '物防の祝福', '魔法耐性上昇【D】']),
  a('ユーディー', 'Hero of Tempest', 3, 'B', 'P', ['全体回復ボーナス', '風の呪詛', '魔法耐性上昇']),
  a('ライザ', 'Master\'s Right-Hand', 3, 'Y', 'B', ['剛力の祝福', '斬の盾', '物理ブレイクダメージ上昇']),
  a('ライザ', 'One Summer Story', 3, 'G', 'R', ['魔防の祝福', '風の祝福', '火ダメージ上昇']),
  a('リディー', 'Rainbow Canvas', 3, 'P', 'B', ['雷の呪詛', '使い切り回復強化', '全体回復量上昇']),
  ...
  a('レジナ', '遺跡発掘屋', 1, 'G', 'R', ['打の祝福', '雷の盾', '火耐性上昇']),
